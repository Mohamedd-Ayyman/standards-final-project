      ...
      <div className="relative z-10 px-4 py-16" ref={contentRef}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {/* Basic Information Section with Validation */}
            ...
            {/* ... rest of your form sections (Hand Hygiene, PPE, Observations) remain the same ... */}

            {/* Action Buttons */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 fadeUp">
              <button
                onClick={handleDownload}
                disabled={isGenerating}
                className={`w-full text-white rounded-2xl py-4 px-8 font-bold text-xl transform hover:scale-105 transition-all duration-300 shadow-2xl flex items-center justify-center gap-2 ${
                  isGenerating
                    ? "bg-gradient-to-r from-teal-700 to-green-700 cursor-not-allowed"
              ...
              <button
                onClick={handleReset}
                className="w-full bg-gradient-to-r from-gray-600 to-gray-700 text-white rounded-2xl py-4 px-8 font-bold text-xl hover:from-gray-700 hover:to-gray-800 transform hover:scale-105 transition-all duration-300 shadow-2xl"
              >
                Clear Form
              </button>
            </div>
            ...
            <div className="fadeUp">
              <div className="bg-[#2B624E] bg-opacity-10 backdrop-blur-lg rounded-2xl p-4 border border-white border-opacity-10">
